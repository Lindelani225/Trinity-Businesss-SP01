    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.d.length != 0) {
                ...
                window.location = "/Supplier/CollectionSuccess"; //If QRCode == "Delivery Confirmed"
        ...
        error: function (data) {
            ...
            window.location = "/Supplier/CollectionError"; //If QRCode != "Delivery Confirmed"
            $("#upload").removeAttr('disabled');
            $("#upload").attr("value", "Upload");
        },
        async: false
...
function take_snapshot() {
    ...
    webcam.set_api_url('/Supplier/UploadFlash?type=' + selection);
